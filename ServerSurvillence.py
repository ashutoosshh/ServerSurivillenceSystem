...
def Send_Email(sender_email, app_password, recivers_email,
...
def main():
    ...
    if (len(sys.argv) == 2):
        ...
        if (sys.argv[1] == "--h" or sys.argv[1] == "--H"):
            ...
            print("3 : Sends mail with log file")
        ...
        try:
            while True:
                ...
                def LogThread():
                    ...
                    log_file_path = CreateLog(sys.argv[2])
...
"""
                ...
                print("Log generated and mail sent successfully")

                time.sleep(int(sys.argv[1]) * 60)

        except KeyboardInterrupt:
            print("\nPlatform Surveillance System stopped by user safely")
